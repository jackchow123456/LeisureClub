$.fn.jacktree = function (arg) {
    ...
    var DirectoryRoute = 'http://www.leisure_club.com/admin/fileManager/directory';
    var ListFoldersRoute = 'http://www.leisure_club.com/admin/fileManager/listFolders';
    var FilesRoute = 'http://www.leisure_club.com/admin/fileManager/files';
    var CreateRoute = 'http://www.leisure_club.com/admin/fileManager/create';
    var UploadRoute = 'http://www.leisure_club.com/admin/fileManager/upload';
    var DeleteRoute = 'http://www.leisure_club.com/admin/fileManager/delete';
    var MoveRoute = 'http://www.leisure_club.com/admin/fileManager/move';
    var CopyRoute = 'http://www.leisure_club.com/admin/fileManager/copy';
    var RenameRoute = 'http://www.leisure_club.com/admin/fileManager/rename';
    var FoldersRoute = 'http://www.leisure_club.com/admin/fileManager/folders';


    var initHtml = '<!--文件模态框（Modal）--><div class="modal fade"id="fileModel"tabindex="-1"role="dialog"aria-labelledby="myModalLabel"data-backdrop="static"aria-hidden><div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header"><button type="button"class="close"data-dismiss="modal"aria-hidden="true">×</button><h4 class="modal-title"id="fileModalLabel">文件管理</h4></div><div class="modal-body"><div id="container" class="row"><div id="menu"><a tabindex="500"id="create"class="btn btn-sm btn-success"><i class="fa fa-folder"></i>    <span>新建文件夹</span></a><a tabindex="500"id="upload"class="btn btn-sm btn-warning"><i class="fa fa-upload"></i>    <span>上传</span></a><a tabindex="500"id="delete"class="btn btn-sm btn-danger"><i class="fa fa-trash-o"></i>    <span>删除</span></a><a tabindex="500"id="move"class="btn btn-sm btn-primary"><i class="fa fa-hand-o-right"></i>    <span>移动</span></a><a tabindex="500"id="copy"class="btn btn-sm btn-info"><i class="fa fa-copy"></i>    <span>复制</span></a><a tabindex="500"id="rename"class="btn btn-sm btn-warning"><i class="fa fa-tag"></i>    <span>重命名</span></a><a tabindex="500"id="refresh"class="btn btn-sm btn-default"><i class="fa fa-refresh"></i>    <span>刷新</span></a></div><div style="clear:both;"></div><div id="column-left" class="col-sm-3"></div><div id="column-right" class="col-sm-8"><div class="topDiv"><div class="sortDiv"><a class="asc"id="sortName">按文件名排序</a><a id="sortSize">按文件大小排序</a><a id="sortTime">按添加时间排序</a></div><div class="typeDiv"><a class="active"id="grid">网格</a><a id="list">列表</a></div></div><div class="fileList"></div></div></div></div><div class="modal-footer"><button type="button"class="btn btn-default"data-dismiss="modal">关闭</button><button type="button"class="btn btn-primary confirmBtn">提交更改</button></div></div></div></div>'

    if ($('#fileModel').length == 0) {
        arg.target ? $(arg.target).after(initHtml) : this.after(initHtml);
    }
